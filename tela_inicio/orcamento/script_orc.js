const firebaseConfig = {
  ...
  function submitForm(e) {
    ...
    saveMessages(CPF,nome,telefone,email,endereco,numPedido,name1,qtd1,larg1,comp1,total1,total_final,name2,qtd2,larg2,comp2,total2);
...
function readFom() {
  ...
  firebase
    ...
    .on("value", function (snap) {
      document.getElementById("pedido").value = snap.val().numPedido;
